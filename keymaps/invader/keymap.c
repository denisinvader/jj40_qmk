...
[_QWERTY] = LAYOUT_planck_mit(
    ...
    KC_LCTL, KC_LCTL, KC_LALT, KC_LGUI, LOWER, RSFT_T(KC_SPC), RAISE, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT
),
 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |Reset |      |AGnorm|AGswap|      |             |      |      |Qwerty|Colemk|Dvorak|
 * `-----------------------------------------------------------------------------------'
 */
[_ADJUST] = LAYOUT_planck_mit(
    _______, RGB_TOG, RGB_MOD, RGB_HUI, RGB_SAI, RGB_VAI, _______, _______, _______, _______, _______, KC_DEL,
    _______, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, _______, _______, _______, _______, _______,
    _______, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, _______, _______, _______, _______, _______,
    RESET, _______, AG_SWAP, AG_NORM, _______, _______, _______, _______, _______, _______, _______
)
